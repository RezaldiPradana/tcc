...
1. Silahkan buat **docker-compose.yml**
```
version: '3.3'
...
2. Kemudian jalankan menggunakan **docker-compose up**
```
...
3. Kemudian coba akses menggunakan aplikasi browser anda
![halaman awal instalasi Drupal](1.png)
4. Lakukan installasi drupal
